...
def train_biobert_model(train_path, val_path, output_dir, model_name='models/biobert'):
    ...
    print(f"\nBest Valid Accuracy: {metrics['eval_accuracy']:.4f}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str, default="models/biobert")
    parser.add_argument("--output_dir", type=str, required=True)

    args = parser.parse_args()

    train_path = os.path.join(args.data_dir, "train.jsonl")
    val_path = os.path.join(args.data_dir, "valid.jsonl")

    print(f"Train file: {train_path}")
    print(f"Valid file: {val_path}")
